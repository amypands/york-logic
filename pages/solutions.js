  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="GCP solutions, Google Cloud Platform solutions, cloud computing solutions, custom solutions"
        />
        <meta
          name="description"
          content="Discover our customized GCP solutions designed to meet the unique needs of your business and help you get the most out of Google Cloud Platform"
        />
        ...
        <div className="container mt-4">
          <div className="row">
            <div className="col-md-6 pe-5 pt-5 solution-content-left">
              ...
              <h2>
                Helping you unlock the full potential of Google Cloud Platform
                for your business
              </h2>
            </div>
                ...
                {content.map((contentItem) => {
                  return (
                    <div className="mb-5">
                      ...
                      <ul>
                        {contentItem.bullets.map((bulletPoints) => {

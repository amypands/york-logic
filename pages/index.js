...
export default function Home() {
  return (
    <>
      <Head>
        <title>York Logic Limited</title>
        <meta
          name="keywords"
          content="GCP, Google Cloud Platform, cloud computing, consulting, implementation, support"
        />
        <meta
          name="description"
          content="Expert GCP consulting and implementation services for businesses. Get support for all your Google Cloud Platform needs"
        />
        ...
        <div className="row gx-0 yorkheader">
          <div className="col-md-6 leftcolumn">
            <div className="hometext">
              <h1>
                <strong>York Logic Limited</strong>
              </h1>
              <div className="row">
                <div className="col-md-4 yorkdescription">
                  <p>
                    <strong>Simplify Technology</strong>
                  </p>
                  <p>
                    <strong>Be a Cloud Native in Google Cloud</strong>
                  </p>
                </div>
                <div className="col-md-8 yorkbullets">
                  ...
                  <p>
                    Google Cloud Architecture, Onboarding and Transformation
                  </p>
                  <p>DevOps and SRE</p>
                </div>
              </div>
      ...
      <div className="row gx-0 yorkcontainer">
        <div className="col-md-12 yorkimage"></div>
      </div>
    </>
